...
class GenreServiceImplTest {
    ...
    void getGenreById() {
        final String response = service.getGenreById(Long.parseLong(ID_FIRST_GENRE));
        assertThat(response)
    ...
    void deleteGenreById() {
        ...
        final String response = service.deleteGenreById(Long.parseLong(ID_FIRST_GENRE));
        assertThat(response)
    ...
    void updateGenre() {
        ...
        final String response = service.updateGenre(Long.parseLong(ID_FIRST_GENRE), UPDATE_GENRE_NAME);
        assertThat(response)
